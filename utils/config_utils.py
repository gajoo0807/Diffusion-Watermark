...
def validate_distribution_config(condition_config):
    assert 'distribution_condition_config' in condition_config, \
        "Distribution conditioning desired but distribution condition config missing"
    assert 'distribution_embed_dim' in condition_config['distribution_condition_config'], \
        "distribution_embed_dim missing in distribution condition config"
